...
export async function linkMediaAsset(assetId:string,entityType:'user_profile'|'video_post'|'story'|'chat_message'|'shop_product'|'exclusive_content',entityId:string,slot:string,position=0):Promise<void> {
...
export async function getLinkedMediaAssetIds(entityType:'user_profile'|'video_post'|'story'|'chat_message'|'shop_product'|'exclusive_content',entityId:string,slot?:string):Promise<string[]> {
