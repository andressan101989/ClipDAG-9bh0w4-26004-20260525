...
export const productPages: Record<'features' | 'business' | 'ads' | 'marketplace' | 'creators' | 'live', ProductPageContent> = {
  features: {
    ...
    primaryCta: { label: 'Explore the experience', href: '#explore' }, secondaryCta: { label: 'Open Nelyon Business', href: publicCtas.businessHome },
    bridge: { eyebrow: 'Connected by design', title: 'Not separate apps. One evolving ecosystem.', body: 'A discovery moment can lead to a creator, a LIVE experience or a product. Businesses have a dedicated workspace for their side of that journey, including Ads.', links: [{ label: 'Creators', href: publicCtas.creators }, { label: 'Marketplace', href: publicCtas.marketplace }, { label: 'Business', href: publicCtas.business }, { label: 'Ads', href: publicCtas.ads }] },
    sections: [
  ...
  business: {
    ...
    primaryCta: { label: 'Open Nelyon Business', href: publicCtas.businessHome }, secondaryCta: { label: 'Sign in', href: publicCtas.businessLogin },
    bridge: { eyebrow: 'One workspace', title: 'The tools behind the experience.', body: 'Products and orders, media, Ads, Analytics, Finance, payouts and Team live in the private Business workspace. Access follows the permissions granted to each member.', links: [{ label: 'Explore Ads', href: publicCtas.ads }, { label: 'Explore Marketplace', href: publicCtas.marketplace }] },
    sections: [
  ...
  ads: {
    ...
    primaryCta: { label: 'Open Ads Manager', href: publicCtas.businessAds }, secondaryCta: { label: 'Explore Business', href: publicCtas.business },
    bridge: { eyebrow: 'Where campaigns appear', title: 'Placements connected to discovery.', body: 'Campaign placement options include Marketplace home, Marketplace search and Social Feed. Product eligibility and campaign controls stay in Ads Manager.', links: [{ label: 'Marketplace', href: publicCtas.marketplace }, { label: 'Business workspace', href: publicCtas.business }] },
    sections: [
  ...
  marketplace: {
    ...
    primaryCta: { label: 'See how it connects', href: '#explore' }, secondaryCta: { label: 'For businesses', href: publicCtas.business },
    bridge: { eyebrow: 'Social commerce', title: 'Products alongside discovery.', body: 'Browse products and stores while Nelyon connects commerce to Feed, search and creator content where relevant.', links: [{ label: 'Explore creators', href: publicCtas.creators }, { label: 'Business tools', href: publicCtas.business }] },
    sections: [
  ...
  creators: {
    ...
    primaryCta: { label: 'Explore creator tools', href: '#explore' }, secondaryCta: { label: 'Discover LIVE', href: publicCtas.live },
    bridge: { eyebrow: 'Creator identity', title: 'Your presence travels across formats.', body: 'Profiles, published content and community interaction give creators a consistent presence throughout Nelyon.', links: [{ label: 'Explore features', href: publicCtas.features }, { label: 'Discover LIVE', href: publicCtas.live }] },
    sections: [
  ...
  live: {
    ...
    primaryCta: { label: 'Explore LIVE', href: '#explore' }, secondaryCta: { label: 'Meet creators', href: publicCtas.creators },
    bridge: { eyebrow: 'Real-time connection', title: 'Watch, respond, be part of it.', body: 'LIVE brings hosts and viewers into the same moment. Battle interfaces add a shared stage with two sides and a live score.', links: [{ label: 'Creators', href: publicCtas.creators }, { label: 'All features', href: publicCtas.features }] },
    sections: [
    ...
    closing: { title: 'There is more to discover live.', body: 'Explore the creators and content that make real-time moments worth sharing.', cta: { label: 'Meet Nelyon creators', href: publicCtas.creators } },
  },
};
