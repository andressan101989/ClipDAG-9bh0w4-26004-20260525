...
export function App(){return <Routes>
  ...
  <Route element={<AdminRoute/>}><Route element={<AdminShell/>}>
    ...
    <Route element={<CapabilityRoute capability="content.items.read"/>}><Route path="/content-safety" element={<AdminContentSafetyPage/>}/><Route path="/content-safety/audio" element={<AdminContentSafetyAudioPage/>}/><Route path="/content-safety/audio/:id" element={<AdminContentSafetyAudioDetailPage/>}/><Route path="/content-safety/visual" element={<AdminContentSafetyVisualPage/>}/><Route path="/content-safety/visual/:id" element={<AdminContentSafetyVisualDetailPage/>}/><Route path="/content-safety/:id" element={<AdminContentSafetyDetailPage/>}/></Route>
