...
const reconciliationSql = read('supabase/migrations/20260810110000_harden_marketplace_ads_reconciliation.sql');
...
for(const token of['funding_source_difference','funding_escrow_difference','funding_unexpected_entries','spend_escrow_difference','spend_revenue_difference','spend_unexpected_entries','release_escrow_difference','release_destination_difference','release_unexpected_entries','release_wrong_recipient','event_transaction_mismatches','escrow_liability_difference'])assert.match(reconciliationSql,new RegExp(token));
