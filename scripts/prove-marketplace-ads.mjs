...
try {
  ...
  console.log(
    JSON.stringify({
      ...
      visibility: "50%-500ms",
      attributionHours: 24,
      realFixtures:{basicPacing:true,sameBucketRetry:true,pause:true,outOfStock:true,expiry38Plus2Release60:true,impression:true,click:true,productMismatch:true,privacy:true,touchRetry:true,actorConflict:true,categoryExclusion:true,fairRotation:true,sharedCardPrice:true,purchaseAttribution:true,organicExclusion:true},
