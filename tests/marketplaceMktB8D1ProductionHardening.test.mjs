...
test("C2 remained client-only and later authorized correctives add no client economic authority",()=>{
  ...
  assert.deepEqual(later,["20260811034000_marketplace_verified_reviews_branding.sql","20260816010000_marketplace_admin_dispute_resolution_authority.sql","20260816020000_marketplace_buyer_purchase_history.sql","20260816021000_fix_marketplace_buyer_purchase_history_paid_evidence.sql","20260816022000_marketplace_seller_purchase_history.sql"]);
