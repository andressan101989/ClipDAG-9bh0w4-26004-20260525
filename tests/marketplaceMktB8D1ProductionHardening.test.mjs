...
test("C2 remained client-only and later authorized correctives add no client economic authority",()=>{
  ...
  assert.equal(later.pop(),"20260902025229_live_battles_lb4_f5_a_c3_c1_c1_c1_lock_mode_boundary.sql");
  assert.equal(later.pop(),"20260901231742_live_battles_lb4_f5_a_c3_c1_c1_strict_leave_lock_budget.sql");
  assert.equal(later.pop(),"20260901211549_live_battles_lb4_f5_a_c3_c1_bounded_leave_retry.sql");
  assert.equal(later.pop(),"20260901201459_live_battles_lb4_f5_a_c3_active_series_leave.sql");
  assert.equal(later.pop(),"20260831023739_live_battles_lb4_f5_a_rematch_series_authority.sql");
  assert.equal(later.pop(),"20260830195917_live_battles_lb4_f4d_c_visual_realtime.sql");
  assert.equal(later.pop(),"20260830162244_live_battles_lb4_f4d_b_power_projection.sql");
  assert.equal(later.pop(),"20260830053531_live_battles_lb4_f4d_a_power_engine.sql");
  assert.equal(later.pop(),"20260830030845_live_battles_lb4_f4b_score_outcome.sql");
  assert.equal(later.pop(),"20260829225002_live_battles_lb4_f4a_directed_gifts.sql");
  assert.equal(later.pop(),"20260829161856_live_battles_lb4_f3_f3_f1_f2_transition_plan.sql");
  assert.equal(later.pop(),"20260829150940_live_battles_lb4_f3_f3_f1_f1_cancellation_authority.sql");
  assert.equal(later.pop(),"20260829142317_live_battles_lb4_f3_f3_f1_accepted_lifecycle.sql");
  assert.equal(later.pop(),"20260829054911_live_battles_lb4_f3_f3_stale_lifecycle.sql");
  assert.equal(later.pop(),"20260827012913_live_battles_lb4_f3_f2_snapshot_contract.sql");
  assert.equal(later.pop(),"20260826115337_live_battles_lb4_f3_f1_realtime_delete_clock.sql");
  assert.equal(later.pop(),"20260826043828_live_battles_lb4_f3_spectator_projection.sql");
