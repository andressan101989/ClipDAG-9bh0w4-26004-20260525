...
export default function SellerStore(){
 ...
 return <View style={[s.page,{paddingTop:insets.top}]}><SellerScreenHeader title="Configurar tienda" fallbackRoute="/seller"/><View style={s.content}>
 ...
 <Pressable style={s.button} onPress={save}><Text style={s.buttonText}>Guardar tienda</Text></Pressable></View></View>;
}
