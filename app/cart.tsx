        ...
        {cart.items.map(item=><View key={item.key} style={[styles.itemCard,item.availability!=='available'&&styles.itemUnavailable]}
          ...
          <View style={styles.itemTop}>
            ...
            <View style={styles.itemInfo}>
              ...
              {item.attributionId?<Text style={styles.creatorCredit}>Recomendado por {item.creatorDisplayName?`@${item.creatorDisplayName}`:'un creador'}</Text>:null}
