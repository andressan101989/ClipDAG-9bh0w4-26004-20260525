...
export const canonicalDrafts: readonly CanonicalDraft[] = [
  ...
  { document: terms, provenance: [
    p('accounts-eligibility', 'owner_decision_required', ['contexts/AuthContext.tsx:286'], 'Age and consent require owner/legal decision.'),
    p('content-conduct', 'legal_review_required', ['supabase/migrations/20260703212533_migration_to_supabase.sql:125'], 'License, conduct and notice wording remain unapproved.'),
...
export const legacyReconciliation = [
  ...
  legacy('arbitration', '2026 standalone Terms', 'OWNER_DECISION', 'No forum or arbitration model selected', ['app/terms-of-service.tsx:193']),
  legacy('jurisdiction', '2026 standalone Terms', 'OWNER_DECISION', 'No governing jurisdiction selected', ['app/terms-of-service.tsx:193']),
] as const;
