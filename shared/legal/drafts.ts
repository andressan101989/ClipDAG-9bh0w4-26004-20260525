...
export const canonicalDrafts: readonly CanonicalDraft[] = [
  { document: privacy, provenance: [
    ...
    p('legal-choices-contact', 'legal_review_required', ['contexts/AuthContext.tsx:286', 'app/login.tsx:48'], 'Owner chose planned identity, address and 18+ rule in NPW-F-C4. Incorporation, age enforcement, contacts, legal review and dates remain open.'),
  ] },
  { document: terms, provenance: [
    p('accounts-eligibility', 'legal_review_required', ['contexts/AuthContext.tsx:286', 'contexts/AuthContext.tsx:302', 'app/login.tsx:48'], 'Owner selected 18+ with no parental exception; signup lacks age evidence or enforcement. Hard production gate.'),
...
export const legacyReconciliation = [
  ...
  legacy('age 13+', '2025 and 2026 mobile text', 'REWRITE_FACTUAL', 'Owner selected 18+ without parental exception; protected legacy routes remain visible and must be reconciled before launch', ['app/terms-of-service.tsx:73', 'app/legal.tsx:39']),
