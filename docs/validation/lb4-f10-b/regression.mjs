...
const evidence = 'docs/validation/lb4-f10-b/';
const files = readdirSync('tests').filter(f => f.endsWith('.test.mjs')).sort();
const groups = [ ['f10-b', /^liveBattlesLb4F10B/], ['f10-a', /^liveBattlesLb4F10A/], ['media-relay', /Relay|PostRound/i], ['host-ui', /F2Invitation|F8BPhysical|F5BClient|Ui1Figma/i], ['realtime', /Realtime|Subscription|Snapshot|Projection/i], ['agora-auth', /Agora|agoraToken/i], ['f9-b', /^liveBattlesLb4F9BSpectatorControls/], ['viewer-ui', /Lb4F7BViewerUi|Lb4Ui1FigmaStage/], ['gifts', /gift/i], ['c1', /^liveBattlesLb4F9AC1/], ['f9-a', /^liveBattlesLb4F9AScoring/], ['f8', /Lb4F8/],
...
const baseline = normalize(readFileSync('docs/validation/lb4-f10-a/typescript.txt','utf8'));
...
const base = '0d641081bff8f600461c8f73dde9f2098c3fd266';
