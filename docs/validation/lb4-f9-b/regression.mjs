...
const evidence = 'docs/validation/lb4-f9-b/';
const files = readdirSync('tests').filter(f => f.endsWith('.test.mjs')).sort();
const groups = [ ['f9-b', /^liveBattlesLb4F9BSpectatorControls/], ['viewer-ui', /Lb4F7BViewerUi|Lb4Ui1FigmaStage/], ['gifts', /gift/i], ['c1', /^liveBattlesLb4F9AC1/], ['f9-a', /^liveBattlesLb4F9AScoring/], ['f8', /Lb4F8/],
...
const baseline = normalize(readFileSync('docs/validation/lb4-f9-a-c1/typescript.txt','utf8'));
...
const base = 'b3bde1c1b92f749515bc4c142949abb12c361df9';
